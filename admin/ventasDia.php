...
INNER JOIN productos ON productos.id = productos_vendidos.id_producto WHERE ventas.fecha  > DATE_SUB(NOW(), INTERVAL 1 YEAR) 
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<div class="container">
		...
		<div>
			<form action="./ventasDia.php" class="form-inline my-2 my-lg-0 navbar-right" method="POST">
      ...
      <button class="btn btn-info my-2 my-sm-0" type="submit">Buscar</button>
		...
		$sentencia1 = $base_de_datos->query("SELECT ventas.total,  , ventas.fecha, ventas.id, GROUP_CONCAT(	productos.codigo, '..',  productos.descripcion, '..', productos_vendidos.cantidad SEPARATOR '__') 
			...
			WHERE ventas.id = $busqueda GROUP BY ventas.id ORDER BY ventas.id DESC;");
        ...
        <table class="table table-striped table-sm">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-success" href="./ventasDia.php">
        ...
        <table class="table table-striped table-sm">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "./eliminarUltima.php?id=" . $venta->id?>"><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
