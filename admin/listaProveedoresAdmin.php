...
<div class="container">
		<h1>Proveedores</h1>
		<div>
			<a class="btn btn-success" href="./proveedorAdmin.php">Nuevo <i class="fa fa-plus"></i></a>
            </div>
            <table class="table ">
			<thead>
				<tr>
			...
			<tbody>	
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "./eliminarProveedorAdmin.php?id=" . $concepto->id?>"><i class="fa fa-trash"></i></a></td>
				</tr>
			</tbody>
				<?php }
                    ?>
