...
if ($_SESSION['username'] != '' || $_SESSION['nivel'] == 'administrador') {
    ...
    INNER JOIN productos ON productos.id = productos_vendidos.id_producto WHERE ventas.fecha BETWEEN CURRENT_DATE()-7 AND CURRENT_DATE()+1  
...
<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-danger" href="<?php echo "eliminarUltimaVentaCamaAdmin.php?id=" . $venta->id?>"><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
