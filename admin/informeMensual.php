...
INNER JOIN productos ON productos.id = productos_vendidos.id_producto WHERE ventas.fecha  > DATE_SUB(NOW(), INTERVAL 1 MONTH)  GROUP BY ventas.id ORDER BY ventas.id DESC;");
