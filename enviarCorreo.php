...
if($_SESSION['username'] != ''){
    ...
    $nombreProveedor = $correo->nombre;
            ...
            if ($_SESSION['nivel'] == "farmacia") {
             echo '<a href="./pedidos.php"><button type="submit" name="volver" class="btn btn-success">Volver</button></a></center></div>';
            } else {
             echo '<a href="./admin/pedidos.php"><button type="submit" name="volver" class="btn btn-succeess">Volver</button></a></center></div>';
            }
            }else{
              include 'encabezado.php';
                include 'lateral.php';
            ...
            <div class='container'>
                ...
                if($_SESSION['nivel'] == "farmacia") {
                echo "<a href='./pedidos.php'><button type='submit' name='volver' class='btn btn-danger'>Volver</button></a></center></div>";
                }else{
                echo "<a href='./admin/pedidos.php'><button type='submit' name='volver' class='btn btn-danger'>Volver</button></a></center></div>";
            }
          }
}else{
